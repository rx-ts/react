  ...
  var App = (function (superclass) {
    ...
    App.prototype.update = function update (propName) {
      ...
      return function (e) {
        ...
        return this$1.setState(( obj = {}, obj[propName] = e.target.value, obj ));
      }
    };
          ...
          React.createElement( 'ul', { className: "lists" },
            React.createElement( 'li', null,
              ...
              React.createElement( 'input', {
                type: "color", value: state.background, onChange: this.update('background') })
            ),
            React.createElement( 'li', null,
              React.createElement( 'label', null, "backgroundAlpha(0.1-1.0)" ),
              React.createElement( 'input', {
                type: "number", value: state.backgroundAlpha, onChange: this.update('backgroundAlpha') })
            ),
            React.createElement( 'li', null,
              React.createElement( 'label', null, "foreground(color)" ),
              React.createElement( 'input', {
                type: "color", value: state.foreground, onChange: this.update('foreground') })
            ),
            React.createElement( 'li', null,
              React.createElement( 'label', null, "foregroundAlpha(0.1-1.0)" ),
              React.createElement( 'input', {
                type: "number", value: state.foregroundAlpha, onChange: this.update('foregroundAlpha') })
            ),
            React.createElement( 'li', null,
            ...
            React.createElement( 'li', null,
              ...
              React.createElement( 'input', {
                type: "number", value: state.padding, onChange: this.update('padding') })
            ),
            React.createElement( 'li', null,
              React.createElement( 'label', null, "size(px)" ),
              React.createElement( 'input', {
                type: "number", value: state.size, onChange: this.update('size') })
            ),
            React.createElement( 'li', null,
              React.createElement( 'label', null, "value" ),
              React.createElement( 'textarea', {
                rows: "6", cols: "80", value: state.value, onChange: this.update('value') })
            )
          ),
